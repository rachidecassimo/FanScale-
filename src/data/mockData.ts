...
export const INITIAL_TRANSACTIONS: WalletTransaction[] = [
  ...
  },
  {
    ...
    description: 'Apoio direto de fã durante Live Streaming',
    amountMT: 150,
    date: '17 Ago 2026, 20:15',
    rawDate: '2026-08-17',
    status: 'completed',
    provider: 'emola',
  ...
  },
  {
    id: 'tx4',
    type: 'ppv_unlock',
    title: 'Desbloqueio de Música Inédita @yara.cossa.music',
    description: 'Acesso avulso PPV ao acústico "Noites de Maputo"',
    amountMT: 150,
    date: '17 Ago 2026, 16:30',
    rawDate: '2026-08-17',
    status: 'completed',
    provider: 'mpesa',
    referenceNumber: 'PPV-7710291',
    isCredit: false
  },
  {
    id: 'tx5',
    type: 'deposit',
    title: 'Recarga de Saldo via e-Mola',
    description: 'Carregamento por carteira móvel Movitel (+258 86 543 2109)',
    amountMT: 1500,
    date: '15 Ago 2026, 14:00',
    rawDate: '2026-08-15',
    status: 'completed',
    provider: 'emola',
    referenceNumber: 'EM-551029410',
    isCredit: true
  },
  {
    id: 'tx6',
    type: 'subscription',
    title: 'Subscrição Mensal @samira_fashionmz',
    description: 'Acesso VIP a tutoriais de corte e estilo capulana',
    amountMT: 450,
    date: '14 Ago 2026, 10:12',
    rawDate: '2026-08-14',
    status: 'completed',
    provider: 'card',
    referenceNumber: 'SUB-9941029',
    isCredit: false
  },
  {
    id: 'tx7',
    type: 'tip',
    title: 'Gorjeta de Fã a @edson_humor',
    description: 'Apoio pela comédia e incentivo à produção de novos vídeos',
    amountMT: 200,
    date: '12 Ago 2026, 22:40',
    rawDate: '2026-08-12',
    status: 'completed',
    provider: 'mkesh',
    referenceNumber: 'TIP-8819201',
    isCredit: false
  },
  {
    id: 'tx8',
    type: 'creator_revenue',
    title: 'Receita de Subscrição de Fã VIP',
    description: 'Novo membro do plano mensal de @ana.moz',
    amountMT: 499,
    date: '11 Ago 2026, 18:30',
    rawDate: '2026-08-11',
    status: 'completed',
    provider: 'mpesa',
  ...
  },
  {
    ...
    description: 'Transferência de saldo para conta Vodacom M-Pesa (+258 84 999 8888)',
    amountMT: 12000,
  ...
  },
  {
    id: 'tx10',
    type: 'payout',
    title: 'Levantamento para Conta Bancária (BIM / BCI)',
    description: 'Transferência interbancária SIMO Moçambique',
    amountMT: 8500,
    date: '04 Ago 2026, 09:15',
    rawDate: '2026-08-04',
    status: 'completed',
    provider: 'card',
    referenceNumber: 'BNK-1029481',
    isCredit: false
  },
  {
    id: 'tx11',
    type: 'deposit',
    title: 'Recarga Inicial de Carteira',
    description: 'Ativação de conta FanScale com Vodacom M-Pesa',
    amountMT: 5000,
    date: '28 Jul 2026, 16:45',
    rawDate: '2026-07-28',
    status: 'completed',
    provider: 'mpesa',
    referenceNumber: 'MP-110293849',
    isCredit: true
  },
  {
    id: 'tx12',
    type: 'subscription',
    title: 'Subscrição Trimestral VIP @ana.moz',
    description: 'Acesso antecipado a eventos de moda em Maputo',
    amountMT: 1290,
    date: '20 Jul 2026, 11:00',
    rawDate: '2026-07-20',
    status: 'completed',
    provider: 'mpesa',
    referenceNumber: 'SUB-1029381',
    isCredit: false
  }
];
